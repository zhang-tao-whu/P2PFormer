...
from .e2ec import multi_apply

@DETECTORS.register_module()
class InstanceLineSegmentor(SingleStageDetector):
    ...
    def __init__(self,
        ...
        super(InstanceLineSegmentor, self).__init__(backbone, neck, bbox_head, train_cfg,
